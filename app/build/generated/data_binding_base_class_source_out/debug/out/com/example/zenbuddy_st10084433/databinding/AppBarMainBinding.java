...
public final class AppBarMainBinding implements ViewBinding {
  ...
  @NonNull
  public final FloatingActionButton shortcut;

  @NonNull
  public final Toolbar toolbar;

  private AppBarMainBinding(@NonNull CoordinatorLayout rootView,
      @NonNull FloatingActionButton shortcut, @NonNull Toolbar toolbar) {
  ...
  public static AppBarMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.shortcut;
      FloatingActionButton shortcut = ViewBindings.findChildViewById(rootView, id);
      if (shortcut == null) {
        break missingId;
      }
      ...
      return new AppBarMainBinding((CoordinatorLayout) rootView, shortcut, toolbar);
    }
